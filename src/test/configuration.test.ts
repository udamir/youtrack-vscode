...
describe('ConfigurationService', () => {
  ...
  it('should update instance URL in configuration', async () => {
    ...
    expect(mockUpdate.calledWith(CONFIG_INSTANCE_URL, 'https://new.example.com', vscode.ConfigurationTarget.Global)).toBeTruthy();
  });
  ...
  it('should update token storage method in configuration', async () => {
    ...
    expect(mockUpdate.calledWith(CONFIG_TOKEN_STORAGE, TOKEN_STORAGE_SETTINGS, vscode.ConfigurationTarget.Global)).toBeTruthy();
  });
